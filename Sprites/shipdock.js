//the dock where the ship can be safely docked
function shipDock() {
    //create private variables for the x coordinates
    var x = 720,
        y = 790;
    
    //create the draw method for the ship dock
    shipDock.prototype.draw = function (context) {
